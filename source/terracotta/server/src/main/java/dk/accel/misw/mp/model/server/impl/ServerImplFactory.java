...
public class ServerImplFactory {
	...
	public ServerImplFactory(String serverId, String tcConfig) {
		this.subscriptionMultiplexer = new SubscriptionMultiplexerImpl(serverId, tcConfig);
	...
	public TurbineSubscriptionServiceManagerAdmin newTurbineSubscriptionServiceManager() {
		return new TurbineSubscriptionServiceManagerImpl(subscriptionMultiplexer, new BroadcastServer());
	}
