...
public class NodeImplFactory {
	...
	public static NodeSubscriptionService newNodeSubscriptionService(TurbineId turbineId, List<String> serverIpList) {
		return new NodeSubscriptionServiceImpl(turbineId, serverIpList);
	}
