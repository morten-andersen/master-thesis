...
public class Main {
	...
	public static void main(String[] args) throws Exception{
		...
		NodeSubscriptionService nodeSubscriptionService = NodeImplFactory.newNodeSubscriptionService(turbineId, Arrays.asList(Arrays.copyOfRange(args, 1, args.length)));
	...
	/**
	 * TODO - Hazelcast don't give us any indications of callback errors, 
