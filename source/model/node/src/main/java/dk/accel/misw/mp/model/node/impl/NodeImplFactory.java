...
public class NodeImplFactory {
	...
	public static BroadcastClient newBroadcaster(TurbineId turbineId, NodeSubscriptionService nodeSubscriptionService) {
		return new BroadcastClientImpl(turbineId, nodeSubscriptionService);
	}
	
	public static NodeSubscriptionService newNodeSubscriptionService(TurbineId turbineId, ErrorHandler errorHandler) {
		return new NodeSubscriptionServiceImpl(turbineId, errorHandler);
	}
